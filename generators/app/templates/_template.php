 ...
 * @param $hook
 *   The name of the template being rendered. This is usually "html", but
 *   this function to have consistent variables.
 */
function <%= theme_name %>_preprocess_html(&$variables, $hook) {
  // Add variables and paths needed for HTML5 and responsive support.
  $variables['base_path'] = base_path();
  $variables['theme_path'] = drupal_get_path('theme', '<%= theme_name %>');
 ...
 */
function <%= theme_name %>_process_html(&$variables, $hook) {
 ...
 */
function <%= theme_name %>_preprocess_page(&$variables, $hook) {
 ...
 *   An array of variables to pass to the theme template.
 */
function <%= theme_name %>_process_page(&$variables) {
 ...
 */
function <%= theme_name %>_preprocess_node(&$variables, $hook) {
 ...
 */
function <%= theme_name %>_preprocess_comment(&$variables, $hook) {
 ...
 */
function <%= theme_name %>_preprocess_taxonomy_term(&$variables) {
  // Add a suggestion based on view_mode.
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function <%= theme_name %>_preprocess_block(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function <%= theme_name %>_process_block(&$variables, $hook) {
 ...
 */
function <%= theme_name %>_css_alter(&$css) {
